...
import com.cursokotlin.codechallenge.presentation.ui.adapter.CharactersListAdapter
...
//        viewModel.getEvents()
    ...
    private fun navigateToEventsFragment() {
        val action = HomeFragmentDirections.actionCharactersFragmentToEventsFragment()
